...
public class WaypointFollower : MonoBehaviour
{
    ...
    [SerializeField] bool _faceWaypoints;
    ...
    void FaceCurrentWaypoint()
    {
        ...
        var updatedDirection = new Vector3(targetDirection.y,0, targetDirection.z);
        Vector3 newDirection = Vector3.RotateTowards(transform.forward, targetDirection, _step, 0.0f);
        //Vector3 newDirection = Vector3.RotateTowards(transform.forward, updatedDirection, _step, 0.0f);
